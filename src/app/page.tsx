...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      kpis={[
        {
          value: "Scalable Systems",          label: "Architecture"},
        {
          value: "Intelligent Automation",          label: "Efficiency"},
        {
          value: "Seamless Integration",          label: "Connectivity"},
      ]}
  ...
  <div id="services" data-section="services">
      ...
      features={[
        ...
        {
          icon: Code2,
          title: "Engineering",          description: "Building robust, scalable, and secure software platforms using cutting-edge technologies and best practices."},
        {
          icon: Cloud,
          title: "Cloud & DevOps",          description: "Implementing agile development, seamless deployment, and optimized cloud infrastructure for peak performance."},
        {
          icon: Sparkles,
  ...
  <div id="platforms" data-section="platforms">
      ...
      products={[
        {
          id: "saas-platforms",          name: "SaaS Platforms",          price: "Custom",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-clean-high-end-ui-mockup-for-a-saas-pl-1774469591483-eef4a293.png",          imageAlt: "SaaS platform UI mockup"},
        {
          id: "workflow-automation",          name: "Workflow Automation",          price: "Custom",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-clean-ui-mockup-illustrating-workflow--1774469591275-5dbbd655.png",          imageAlt: "Workflow automation UI mockup"},
        {
          id: "ai-integrations",          name: "AI Integrations",          price: "Custom",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-clean-ui-mockup-for-ai-integrations-sh-1774469591777-e54e3a7a.png",          imageAlt: "AI integrations UI mockup"},
        {
          id: "data-systems",          name: "Data Systems",          price: "Custom",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-clean-ui-mockup-for-robust-data-system-1774469592098-1838c03e.png",          imageAlt: "Data systems UI mockup"},
      ]}
  ...
  <div id="case-studies" data-section="case-studies">
      ...
      blogs={[
        {
          id: "ai-analytics",          category: "AI & Data",          title: "Transforming Decisions with AI Analytics",          excerpt: "Implemented an advanced AI analytics platform, enhancing data-driven decision-making and operational efficiency for a global enterprise.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-soft-high-end-visual-for-an-ai-analyti-1774469591983-61d3a17a.png",          imageAlt: "AI Analytics Platform UI mockup",          authorName: "AERRATRIC Team",          authorAvatar: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-minimalist-abstract-software-dashboard-1774469590789-37351c22.png",          date: "October 26, 2023"},
        {
          id: "enterprise-automation",          category: "Automation",          title: "Streamlining Operations with Enterprise Automation",          excerpt: "Developed a robust enterprise automation system that optimized critical workflows, reducing manual effort and improving resource utilization.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-soft-high-end-visual-for-an-enterprise-1774469591234-82fd9a72.png",          imageAlt: "Enterprise Automation System UI mockup",          authorName: "AERRATRIC Team",          authorAvatar: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-minimalist-abstract-software-dashboard-1774469590789-37351c22.png",          date: "November 15, 2023"},
        {
          id: "saas-dashboard",          category: "SaaS Solutions",          title: "Elevating User Experience with a New SaaS Dashboard",          excerpt: "Designed and engineered an intuitive SaaS dashboard solution, significantly boosting user engagement and product adoption for a growing startup.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-soft-high-end-visual-for-a-saas-dashbo-1774469593515-5cac0778.png",          imageAlt: "SaaS Dashboard Solution UI mockup",          authorName: "AERRATRIC Team",          authorAvatar: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BRQDoIB9NyK61wKPrMx774LuGA/a-minimalist-abstract-software-dashboard-1774469590789-37351c22.png",          date: "December 01, 2023"},
      ]}
    />
  </div>
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        {
          id: "solutions",          value: "100+",          description: "Solutions Delivered"},
        {
          id: "development",          value: "End-to-End",          description: "SaaS Development"},
        {
